...
def process_report(result_filepath, o_xref, p_xref, client_short_name, case_data_confirm):
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        headers2 = ['Petitioner Name', 'Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Created Date', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'Case Approved Date', 'GT Representative']

        headers_table2 = ['PetitionerName','Primary_Petitioner','BeneficiaryType','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote','CaseSourceCreatedDate', 'CaseDescription','CaseFiledDate', 'PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CaseApprovedDate','CasePrimaryCaseManager']
        ...
        headers2 = ['Petitioner Name', 'Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Created Date', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'Case Approved Date', 'GT Representative']
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        headers23 = ['Petitioner Name', 'Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Created Date', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'Case Approved Date', 'GT Representative']

        headers_table23 = ['PetitionerName','Primary_Petitioner','BeneficiaryType','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote','CaseSourceCreatedDate', 'CaseDescription','CaseFiledDate', 'PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CaseApprovedDate','CasePrimaryCaseManager']
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        headers3 = ['Petitioner Name', 'Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Created Date', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'Case Approved Date', 'GT Representative']

        headers_table3 = ['PetitionerName','Primary_Petitioner','BeneficiaryType','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote','CaseSourceCreatedDate', 'CaseDescription','CaseFiledDate', 'PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CaseApprovedDate','CasePrimaryCaseManager']
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        headers4 = ['Petitioner Name', 'Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Created Date', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'Case Approved Date', 'GT Representative']

        headers_table4 = ['PetitionerName','Primary_Petitioner','BeneficiaryType','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote','CaseSourceCreatedDate', 'CaseDescription','CaseFiledDate', 'PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CaseApprovedDate','CasePrimaryCaseManager']
