...
SEND_MAIL = 'NO' #YES/NO
SEND_MAIL_TO_CLIENT = 'YES' #YES/NO
...
def update_log(client_name, status, file1, file2, e ):
    try:
        today = date.today()
        year = today.year
        month = today.month
        ...
        sheet = book2.active                
        sheet.append((today, week_day, client_name, 'Processed', status, file1, file2, str(e)) )
...
def process_report(result_filepath, o_xref, p_xref, client_short_name, case_data_confirm):
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        #done
        headers2 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)','Email Address', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Description', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'GT Representative']

        headers_table2 = ['Primary_Petitioner','BeneficiaryType','WorkEmail','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote', 'CaseDescription','PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CasePrimaryCaseManager']
        ...
        headers2 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)','Email Address','Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Description', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country','GT Representative']
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        headers23 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)','Email Address', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'GT Representative']

        headers_table23 = ['Primary_Petitioner','BeneficiaryType','WorkEmail','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote', 'CaseDescription','CaseFiledDate', 'PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CasePrimaryCaseManager']
        ...
        headers23 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)','Email Address', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Description', 'Case Filed Date', 'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'GT Representative']
    ...
    if (client_short_name.strip()).casefold() == "Alcon".casefold() or (client_short_name.strip()).casefold() == "Fractal".casefold():
        ...
        headers3 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Description', 'Case Filed Date', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Next Step To Be Completed', 'Case Next Step To Be Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country','GT Representative']

        headers_table3 = ['Primary_Petitioner','BeneficiaryType','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote', 'CaseDescription','CaseFiledDate','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','NextStepAction','NextStepActionDueDate','PriorityDate','PriorityCategory','PriorityCountry','CasePrimaryCaseManager']
        ...
        headers3 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Description', 'Case Filed Date','Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'GT Representative']
    ...
    #Tab 5
    headers5 = ['Petitioner of Primary Beneficiary', 'Beneficiary Type (Employee / Dependent)', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)',  'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'Case Created Date', 'Case Description', 'Case Filed Date',  'Primary Case Status', 'Secondary Case Status', 'Case Comments', 'Case Last Step Completed', 'Case Last Step Completed Date', 'Case Priority Date', 'Case Priority Category', 'Case Priority Country', 'Country of Birth']

    headers_table5 = ['Primary_Petitioner','BeneficiaryType','EmployeeId','LastName','FirstName','MiddleName','PrimaryBeneficiaryLastName','PrimaryBeneficiaryFirstName','RelationType','ImmigrationStatus','ImmigrationStatusExpirationDate','I797ExpirationDate','FinalNivDate','MaxOutDateNote','CaseSourceCreatedDate', 'CaseDescription','CaseFiledDate', 'PrimaryCaseStatus','SecondaryCaseStatus','CaseComments','LastStepCompleted','LastStepCompletedDate','PriorityDate','PriorityCategory','PriorityCountry','BirthCountry']
    ...
    headers = [ 'Petitioner Name','Petitioner of Primary Beneficiary','Beneficiary Type (Employee / Dependent)', 'Beneficiary Record Creation Date', 'Beneficiary Employee Id', 'Beneficiary Last Name', 'Beneficiary First Name', 'Beneficiary Middle Name', 'Primary Beneficiary Last Name', 'Primary Beneficiary First Name', 'Relation', 'Country of Birth', 'Country of Citizenship', 'Immigration Status (I-94)', 'Immigration Status Expiration Date (I-94)', 'I-797 Status', 'I-797 Expiration Date', 'Final NIV (Maxout) Date', 'Maxout Date Applicability and Note', 'PED', 'EAD Type', 'EAD Expiration Date', 'AP Expiration Date', 'DS-2019 Valid From', 'DS-2019 Expiration Date', 'Re-Entry Permit Expiration Date', 'Green Card Expiration Date', 'Passport Expiration Date', 'Visa Type', 'Visa Expiration Date', 'Employee Hire Date', 'Current Job Title', 'Work Address-Street', 'Work Address-City', 'Work Address-State', 'Work Address-Zip', 'Work Address-Country']

    headers_table = [ 'PetitionerName','Primary_Petitioner','BeneficiaryType', 'SourceCreatedDate', 'EmployeeId', 'LastName', 'FirstName', 'MiddleName', 'PrimaryBeneficiaryLastName', 'PrimaryBeneficiaryFirstName', 'RelationType', 'BirthCountry', 'CitizenshipCountry', 'ImmigrationStatus', 'ImmigrationStatusExpirationDate', 'MostRecentI797Status', 'I797ExpirationDate', 'FinalNivDate', 'MaxOutDateNote', 'VisaPedDate', 'EadType', 'EadExpirationDate', 'AdvanceParoleExpirationDate', 'Ds2019ValidFromDate', 'Ds2019ExpirationDate', 'ReEntryPermitExpirationDate', 'GreenCardExpirationDate', 'MostRecentPassportExpirationDate', 'VisaType', 'VisaExpirationDate', 'HireDate', 'JobTitle', 'Address1', 'City', 'StateProvince', 'ZipCode', 'Country']
...
def send_email(filename, results, filename2, send_exp_report, client_short_name):
    ...
    if length > 0:
        try:
            ...
            #print(receivers_cc_mail)
            if SEND_MAIL_TO_CLIENT == "NO":
                if ENVIRONMENT == "PRODUCTION":
                    receivers_mail = ('shiv@immilytics.com').split(';')
                    receivers_cc_mail = ('shiv@immilytics.com').split(';')
                else:
                    receivers_mail = ('nvijaymuthumanickam@gmail.com').split(';')
                    receivers_cc_mail = ('nvijaymuthumanickam@gmail.com').split(';')
        ...
        update_log(str(client_short_name), 'Not Sent', filename, filename2, 'No Mail ID for the client' )
